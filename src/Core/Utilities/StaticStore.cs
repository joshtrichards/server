...
public class StaticStore
{
    static StaticStore()
    {
        ...
        //
        // This list is alphabetized by solely key for convenience (since we can't use the domains themselves due to discrepancies)
        //
        // NOTE 1: When updating existing *or* adding new entries PLEASE do a quick search for duplicates to avoid overlaps!
        // NOTE 2: Since this is security software, please be certain domains share common ownership, are legitimate, etc.
        // NOTE 3: If you are adding a completely new entry (key), you'll also need to add a new entry here to src/Core/Enums/GlobalEquivalentDomainsType.cs
        //
